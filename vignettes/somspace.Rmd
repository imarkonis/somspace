...
The Old World Drought Atlas [[Cook et al., 2016](link)] was used, as pre-processed by [Markonis et al. [2018]](link). The file can be downloaded [here](https://shiny.fzp.czu.cz/KVHEM/OWDA/app9b73ae0021d7e57ccae64a7573589ebc/session/a9c548ee2da4242d12da94cd1df223a2/download/downloadData?w=), and is a `data.table` object saved as an `rds` file.

```{r}
library(somspace)
owda <- readRDS('../../owda_1000.rds')
str(owda)
```
